#ifndef __SETUP_SCREEN_BASE_H
#define __SETUP_SCREEN_BASE_H
 ...
 */
class SetupScreenBase : public UIScreen, public IScrollableListDataSource {
  protected:
    /**
  ...
  public:
     ...
     */
    SetupScreenBase(TFT_eSPI &tft, const char *screenName);
    virtual ~SetupScreenBase() = default;
